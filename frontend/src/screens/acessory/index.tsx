...
export const Acessory: React.FC = () => {
  const [isLoading, setIsLoading] = useState(false);
  const [acessory, setAcessoryData] = useState<IProduct[]>([]);
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(
          "https://api.mercadolibre.com/sites/MLB/search?q=acessorios"
        );
        setAcessoryData(response.data.results);
      } catch (error) {
